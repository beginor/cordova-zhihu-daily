System.register(['angular2/platform/browser', 'angular2/http', 'angular2/router', './app.component', './model.service'], function(exports_1) {
    var browser_1, http_1, router_1, app_component_1, model_service_1;
    return {
        setters:[
